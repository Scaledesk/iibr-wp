                        ...
                        <div class="col-md-3">
                            <div class="widget widget-links">
                                ...
                                <ul>
                                    ...
                                    <li><a href="<?php echo get_site_url(); ?>/pgdm-ba">Programme</a></li>
                                    <li><a href="<?php echo get_site_url(); ?>/infrastructure">Campus</a></li>
                                    <li><a href="<?php echo get_site_url(); ?>/events-at-asm">News & Events</a></li>
                                    <li><a href="<?php echo get_site_url(); ?>/placements">Placements</a></li>
                                    <li><a href="<?php echo get_site_url(); ?>/life-at-asm">Gallery</a></li>
